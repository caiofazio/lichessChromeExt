...
// ==/UserScript==
    ...
    function engineOutput(a,b,c){
        ...
        let circle = document.createElementNS(svgns, 'circle');
            circle.setAttributeNS(null, 'cx', (piecesizefa * (lastMoveFa.charCodeAt(0) - 97 + 1)) - (piecesizefa/2));
            circle.setAttributeNS(null, 'cy', (piecesizefa * (9 - (parseInt(lastMoveFa.charAt(1), 10))))- (piecesizefa/2 ));
        ...
        let circle1 = document.createElementNS(svgns, 'circle');
            circle1.setAttributeNS(null, 'cx', (piecesizefa * (lastMoveFa.charCodeAt(2) - 97 + 1))- (piecesizefa/2));
            circle1.setAttributeNS(null, 'cy', (piecesizefa * (9 - (parseInt(lastMoveFa.charAt(3), 10))))- (piecesizefa/2));
            circle1.setAttributeNS(null, 'r', 35);
